👋 Hi, I’m @Crozwords, organizer for the Kaizo Tournaments. 
...
Setting string for the tourny will be: <br> **somethingsmart randomizer** 321WRIEEgKYAJsAngCRAAKeBhsEiAEAFAACCQAuEgAAAAABzBCI5ATkQYgICTIGBQIyAAUYAcwQiAAAAAEVUG9rZW1vbiBIZWFydEdvbGQgKFUplB2AW0BtNeY=  <br>
...
| Sketch and Poison Heal |You may not obtain a move from Sketch from a wild pokemon, or farm for Posion moves from wild pokemon if you have the ability *Poison Heal*. Sketch overall power is very high - and in a tournament setting instead of hand-picking a move and spending hours finding it - you now have to weigh the cost of carrying an empty move slot and waste a turn in a trainer battle to teach. Poison Heal is the same - if you are poisoned with poison heal in a trainer battle, or incidentally on a wild, you may keep the status until you decide to heal. You may under no circumstance farm wild patches to obtain the poison status. |
