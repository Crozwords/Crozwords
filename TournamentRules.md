...
| Fire Red **(Smart)** | 321WRIEEjIBAAQABwCRAAKeBhsEiAEAiAACCQAuEgAAAAAAhRi45ATkAYYICTIGBAIyAAUYAIUYuAAAAAAQRmlyZSBSZWQgKFUpIDEuMfenn9d39euX |
...
|| HOWEVER, both players may NOT run the same Pokémon. This also applies to pivot mons. If PLAYER 1 catches a pokemon to pivot to, and examines it's stats, PLAYER 2 may NO LONGER PIVOT to that mon when they run the seed. |
